...
## [Установка](../docs-ref-conceptual/install-azure-cli.md)
## [Приступая к работе](../docs-ref-conceptual/get-started-with-azure-cli.md)
## [Cloud Shell](/azure/cloud-shell/overview)
## [Вход](../docs-ref-conceptual/authenticate-azure-cli.md)
### [Создание субъекта-службы](../docs-ref-conceptual/create-an-azure-service-principal-azure-cli.md)
## [Интерактивный режим](../docs-ref-conceptual/interactive-azure-cli.md)
## Развернуть
...
# [Справочные материалы](index.pycliyml)
...
## [Служба приложений](appservice.pycliyml "az appservice")
### [List-Locations](appservice.pycliyml#list-locations "az appservice list-locations")
### [Планы](appservice\plan.pycliyml "az appservice plan")
...
### [Веб-приложения](appservice\web.pycliyml "az appservice web")
...
#### [Конфигурация](appservice\web\config.pycliyml "az appservice web config")
...
##### [Параметры приложения](appservice\web\config\appsettings.pycliyml "az appservice web config appsettings")
...
##### [Резервные копии](appservice\web\config\backup.pycliyml "az appservice web config backup")
...
##### [Параметры контейнера](appservice\web\config\container.pycliyml "az appservice web config container")
...
##### [Имена узлов](appservice\web\config\hostname.pycliyml "az appservice web config hostname")
...
##### [SSL-сертификаты](appservice\web\config\ssl.pycliyml "az appservice web config ssl")
...
#### [Развернутые службы](appservice\web\deployment.pycliyml "az appservice web deployment")
...
##### [Слоты развертывания](appservice\web\deployment\slot.pycliyml "az appservice web deployment slot")
...
##### [Пользователи развертывания](appservice\web\deployment\user.pycliyml "az appservice web deployment user")
...
#### [Журналы](appservice\web\log.pycliyml "az appservice web log")
...
#### [Система управления версиями](appservice\web\source-control.pycliyml "az appservice web source-control")
...
### [Приложения](ad\app.pycliyml "az ad app")
...
### [Группы](ad\group.pycliyml "az ad group")
...
#### [Член](ad\group\member.pycliyml "az ad group member")
...
### [Субъекты-службы](ad\sp.pycliyml "az ad sp")
...
### [Пользователи](ad\user.pycliyml "az ad user")
...
## [Пакетная служба](batch.pycliyml "az batch")
### [Учетные записи](batch\account.pycliyml "az batch account")
...
#### [Создаваемые автоматически ключи к хранилищу данных](batch\account\autostorage-keys.pycliyml "az batch account autostorage-keys")
##### [Sync](batch\account\autostorage-keys.pycliyml#sync "az batch account autostorage-keys sync")
#### [Ключи](batch\account\keys.pycliyml "az batch account keys")
...
### [Приложения](batch\application.pycliyml "az batch application")
...
#### [Пакеты](batch\application\package.pycliyml "az batch application package")
...
#### [Сводки](batch\application\summary.pycliyml "az batch application summary")
...
### [Сертификаты](batch\certificate.pycliyml "az batch certificate")
...
### [Расписания заданий](batch\job-schedule.pycliyml "az batch job-schedule")
...
### [Задания](batch\job.pycliyml "az batch job")
...
#### [Статистика](batch\job\all-statistics.pycliyml "az batch job all-statistics")
##### [Show](batch\job\all-statistics.pycliyml#show "az batch job all-statistics show")
#### [Состояние](batch\job\prep-release-status.pycliyml "az batch job prep-release-status")
##### [List](batch\job\prep-release-status.pycliyml#list "az batch job prep-release-status list")
### [Расположения](batch\location.pycliyml "az batch location")
#### [Квоты](batch\location\quotas.pycliyml "az batch location quotas")
...
### [Пулы](batch\pool.pycliyml "az batch pool")
...
#### [Автомасштабирование](batch\pool\autoscale.pycliyml "az batch pool autoscale")
...
#### [Файлы](batch\task\file.pycliyml "az batch task file")
...
#### [Подзадачи](batch\task\subtask.pycliyml "az batch task subtask")
##### [List](batch\task\subtask.pycliyml#list "az batch task subtask list")
## [Выставление счетов](billing.pycliyml "az billing")
### [Счет](billing\invoice.pycliyml "az billing invoice")
#### [Список](billing\invoice.pycliyml#list "az billing invoice list")
#### [Показать](billing\invoice.pycliyml#show "az billing invoice show")
### [Период](billing\period.pycliyml "az billing period")
#### [Список](billing\period.pycliyml#list "az billing period list")
#### [Показать](billing\period.pycliyml#show "az billing period show")
## [CDN](cdn.pycliyml "az cdn")
### [Name-Exists](cdn.pycliyml#name-exists "az cdn name-exists")
### [Usage](cdn.pycliyml#usage "az cdn usage")
### [Личный домен](cdn\custom-domain.pycliyml "az cdn custom-domain")
...
### [Граничный узел](cdn\edge-node.pycliyml "az cdn edge-node")
#### [List](cdn\edge-node.pycliyml#list "az cdn edge-node list")
### [Конечная точка](cdn\endpoint.pycliyml "az cdn endpoint")
...
## [Управление облаком](cloud.pycliyml "az cloud")
...
### [Учетная запись](cognitiveservices\account.pycliyml "az cognitiveservices account")
...
#### [Ключи](cognitiveservices\account\keys.pycliyml "az cognitiveservices account keys")
...
## [Компоненты](component.pycliyml "az component")
...
## [Потребление](consumption.pycliyml "az consumption")
### [Использование](consumption\usage.pycliyml "az consumption usage")
#### [Список](consumption\usage.pycliyml#list "az consumption usage list")
## [Реестр контейнеров](acr.pycliyml "az acr")
...
## [Служба контейнеров](acs.pycliyml "az acs")
...
### [Коллекция](cosmosdb\collection.pycliyml "az cosmosdb collection")
...
### [База данных](cosmosdb\database.pycliyml "az cosmosdb database")
...
### [Учетные записи](dla\account.pycliyml "az dla account")
...
#### [Хранилище BLOB-объектов](dla\account\blob-storage.pycliyml "az dla account blob-storage")
...
#### [Правила брандмауэра](dla\account\firewall.pycliyml "az dla account firewall")
...
### [Каталоги](dla\catalog.pycliyml "az dla catalog")
...
#### [Учетные данные](dla\catalog\credential.pycliyml "az dla catalog credential")
...
#### [Базы данных](dla\catalog\database.pycliyml "az dla catalog database")
...
#### [Внешние источники данных](dla\catalog\external-data-source.pycliyml "az dla catalog external-data-source")
...
#### [Пакет](dla\catalog\package.pycliyml "az dla catalog package")
...
#### [Схемы](dla\catalog\schema.pycliyml "az dla catalog schema")
...
#### [Хранимые процедуры](dla\catalog\procedure.pycliyml "az dla catalog procedure")
...
#### [Секции таблиц](dla\catalog\table-partition.pycliyml "az dla catalog table-partition")
...
#### [Статистика таблиц](dla\catalog\table-stats.pycliyml "az dla catalog table-stats")
...
#### [Типы таблиц](dla\catalog\table-type.pycliyml "az dla catalog table-type")
...
#### [Таблицы](dla\catalog\table.pycliyml "az dla catalog table")
...
### [Учетные записи](dls\account.pycliyml "az dls account")
...
#### [Брандмауэры](dls\account\firewall.pycliyml "az dls account firewall")
...
#### [Доверенные поставщики удостоверений](dls\account\trusted-provider.pycliyml "az dls account trusted-provider")
...
### [Файловая система](dls\fs.pycliyml "az dls fs")
...
#### [Доступ](dls\fs\access.pycliyml "az dls fs access")
...
### [Источники артефактов](lab\artifact-source.pycliyml "az lab artifact-source")
...
### [Артефакты](lab\artifact.pycliyml "az lab artifact")
#### [List](lab\artifact.pycliyml#list "az lab artifact list")
### [Настраиваемые образы](lab\custom-image.pycliyml "az lab custom-image")
...
### [Среда](lab\environment.pycliyml "az lab environment")
...
### [Формулы](lab\formula.pycliyml "az lab formula")
...
### [Образы из коллекции](lab\gallery-image.pycliyml "az lab gallery-image")
#### [List](lab\gallery-image.pycliyml#list "az lab gallery-image list")
### [Секрет](lab\secret.pycliyml "az lab secret")
...
### [Виртуальные сети](lab\vnet.pycliyml "az lab vnet")
#### [Get](lab\vnet.pycliyml#get "az lab vnet get")
#### [List](lab\vnet.pycliyml#list "az lab vnet list")
### [Виртуальные машины](lab\vm.pycliyml "az lab vm")
...
## [Функции](functionapp.pycliyml "az functionapp")
...
### [Конфигурация](functionapp\config.pycliyml "az functionapp config")
#### [Параметры приложения](functionapp\config\appsettings.pycliyml "az functionapp config appsettings")
...
#### [Имя узла](functionapp\config\hostname.pycliyml "az functionapp config hostname")
...
### [Развернутая служба](functionapp\deployment.pycliyml "az functionapp deployment")
...
#### [Источник](functionapp\deployment\source.pycliyml "az functionapp deployment source")
...
#### [Пользователь](functionapp\deployment\user.pycliyml "az functionapp deployment user")
...
## [Содержимое справки](taskhelp.pycliyml "az taskhelp")
### [Deploy-Arm-Template](taskhelp.pycliyml#deploy-arm-template "az taskhelp deploy-arm-template")
## [Интернет вещей](iot.pycliyml "az iot")
### [Устройства](iot\device.pycliyml "az iot device")
...
#### [Обмен сообщениями](iot\device\message.pycliyml "az iot device message")
...
### [Центры](iot\hub.pycliyml "az iot hub")
...
#### [Группы потребителей](iot\hub\consumer-group.pycliyml "az iot hub consumer-group")
...
#### [Задания](iot\hub\job.pycliyml "az iot hub job")
...
#### [Политики](iot\hub\policy.pycliyml "az iot hub policy")
...
### [Сертификаты](keyvault\certificate.pycliyml "az keyvault certificate")
...
#### [Контакты](keyvault\certificate\contact.pycliyml "az keyvault certificate contact")
...
#### [Издатели](keyvault\certificate\issuer.pycliyml "az keyvault certificate issuer")
...
##### [Администраторы](keyvault\certificate\issuer\admin.pycliyml "az keyvault certificate issuer admin")
...
#### [Ожидающие сертификаты](keyvault\certificate\pending.pycliyml "az keyvault certificate pending")
...
### [Ключи](keyvault\key.pycliyml "az keyvault key")
...
### [Секреты](keyvault\secret.pycliyml "az keyvault secret")
...
## [Блокировки](lock.pycliyml "az lock")
...
## [Управляемое приложение](managedapp.pycliyml "az managedapp")
...
### [Определение](managedapp\definition.pycliyml "az managedapp definition")
...
## [Управляемые диски](disk.pycliyml "az disk")
...
### [Подождите](disk.pycliyml#wait "az disk wait")
## [Мониторинг](monitor.pycliyml "az monitor")
### [Журнал действий](monitor\activity-log.pycliyml "az monitor activity-log")
#### [List](monitor\activity-log.pycliyml#list "az monitor activity-log list")
### [Оповещение](monitor\alert.pycliyml "az monitor alert")
...
### [Параметры автомасштабирования](monitor\autoscale-settings.pycliyml "az monitor autoscale-settings")
...
### [Параметры диагностики](monitor\diagnostic-settings.pycliyml "az monitor diagnostic-settings")
...
### [Профили журналов](monitor\log-profiles.pycliyml "az monitor log-profiles")
...
### [Метрики](monitor\metrics.pycliyml "az monitor metrics")
...
### [Базы данных](mysql\db.pycliyml "az mysql db")
#### [List](mysql\db.pycliyml#list "az mysql db list")
### [Журналы сервера](mysql\server-logs.pycliyml "az mysql server-logs")
...
### [Серверы](mysql\server.pycliyml "az mysql server")
...
#### [Конфигурации](mysql\server\configuration.pycliyml "az mysql server configuration")
...
#### [Правила брандмауэра](mysql\server\firewall-rule.pycliyml "az mysql server firewall-rule")
...
## [Сети](network.pycliyml "az network")
### [List-Usages](network.pycliyml#list-usages "az network list-usages")
### [Шлюз приложений](network\application-gateway.pycliyml "az network application-gateway")
...
#### [Пулы адресов](network\application-gateway\address-pool.pycliyml "az network application-gateway address-pool")
...
#### [Сертификаты авторизации](network\application-gateway\auth-cert.pycliyml "az network application-gateway auth-cert")
...
#### [Внешние IP-адреса](network\application-gateway\frontend-ip.pycliyml "az network application-gateway frontend-ip")
...
#### [Интерфейсные порты](network\application-gateway\frontend-port.pycliyml "az network application-gateway frontend-port")
...
#### [Прослушиватели HTTP](network\application-gateway\http-listener.pycliyml "az network application-gateway http-listener")
...
#### [Параметры HTTP](network\application-gateway\http-settings.pycliyml "az network application-gateway http-settings")
...
#### [Пробы](network\application-gateway\probe.pycliyml "az network application-gateway probe")
...
#### [Правила маршрутизации](network\application-gateway\rule.pycliyml "az network application-gateway rule")
...
#### [SSL-сертификаты](network\application-gateway\ssl-cert.pycliyml "az network application-gateway ssl-cert")
...
#### [Политики SSL](network\application-gateway\ssl-policy.pycliyml "az network application-gateway ssl-policy")
...
#### [Сопоставления путей URL-адресов](network\application-gateway\url-path-map.pycliyml "az network application-gateway url-path-map")
...
##### [Правила](network\application-gateway\url-path-map\rule.pycliyml "az network application-gateway url-path-map rule")
...
#### [Параметры брандмауэра веб-приложения](network\application-gateway\waf-config.pycliyml "az network application-gateway waf-config")
...
#### [Наборы записей](network\dns\record-set.pycliyml "az network dns record-set")
...
##### [MX (почта)](network\dns\record-set\mx.pycliyml "az network dns record-set mx")
...
##### [NS-сервер (сервер имен)](network\dns\record-set\ns.pycliyml "az network dns record-set ns")
...
##### [PTR (указатель)](network\dns\record-set\ptr.pycliyml "az network dns record-set ptr")
...
#### [Зоны](network\dns\zone.pycliyml "az network dns zone")
...
### [Каналы ExpressRoute](network\express-route.pycliyml "az network express-route")
...
#### [Аутентификация канала](network\express-route\auth.pycliyml "az network express-route auth")
...
#### [Пиринг](network\express-route\peering.pycliyml "az network express-route peering")
...
### [Локальные шлюзы](network\local-gateway.pycliyml "az network local-gateway")
...
### [Подсистема балансировки нагрузки](network\lb.pycliyml "az network lb")
...
#### [Внутренние пулы адресов](network\lb\address-pool.pycliyml "az network lb address-pool")
...
#### [Внешние IP-адреса](network\lb\frontend-ip.pycliyml "az network lb frontend-ip")
...
#### [Пулы адресов NAT для входящего трафика](network\lb\inbound-nat-pool.pycliyml "az network lb inbound-nat-pool")
...
#### [Правила адресов NAT для входящего трафика](network\lb\inbound-nat-rule.pycliyml "az network lb inbound-nat-rule")
...
#### [Пробы](network\lb\probe.pycliyml "az network lb probe")
...
#### [Правила](network\lb\rule.pycliyml "az network lb rule")
...
### [Группы безопасности сети](network\nsg.pycliyml "az network nsg")
...
### [Общедоступные IP-адреса](network\public-ip.pycliyml "az network public-ip")
...
### [Таблицы маршрутов](network\route-table.pycliyml "az network route-table")
...
#### [Маршруты](network\route-table\route.pycliyml "az network route-table route")
...
### [Фильтр маршрутов](network\route-filter.pycliyml "az network route-filter")
...
#### [Правило](network\route-filter\rule.pycliyml "az network route-filter rule")
...
### [Диспетчер трафика](network\traffic-manager.pycliyml "az network traffic-manager")
#### [Конечные точки](network\traffic-manager\endpoint.pycliyml "az network traffic-manager endpoint")
...
#### [Профили](network\traffic-manager\profile.pycliyml "az network traffic-manager profile")
...
### [Виртуальная сеть](network\vnet.pycliyml "az network vnet")
### [Шлюзы виртуальной сети](network\vnet-gateway.pycliyml "az network vnet-gateway")
...
#### [Отозванные сертификаты](network\vnet-gateway\revoked-cert.pycliyml "az network vnet-gateway revoked-cert")
...
#### [Корневые сертификаты](network\vnet-gateway\root-cert.pycliyml "az network vnet-gateway root-cert")
...
#### [Пиринговые подключения](network\vnet\peering.pycliyml "az network vnet peering")
...
#### [Подсети](network\vnet\subnet.pycliyml "az network vnet subnet")
...
### [VPN-подключения](network\vpn-connection.pycliyml "az network vpn-connection")
...
#### [Политика IPsec](network\vpn-connection\ipsec-policy.pycliyml "az network vpn-connection ipsec-policy")
...
#### [Общие ключи](network\vpn-connection\shared-key.pycliyml "az network vpn-connection shared-key")
...
### [Наблюдатель за сетями](network\watcher.pycliyml "az network watcher")
...
#### [Журнал потоков](network\watcher\flow-log.pycliyml "az network watcher flow-log")
...
#### [Запись пакетов](network\watcher\packet-capture.pycliyml "az network watcher packet-capture")
...
#### [Устранение неполадок](network\watcher\troubleshooting.pycliyml "az network watcher troubleshooting")
...
### [Базы данных](postgres\db.pycliyml "az postgres db")
#### [List](postgres\db.pycliyml#list "az postgres db list")
### [Журналы сервера](postgres\server-logs.pycliyml "az postgres server-logs")
...
### [Серверы](postgres\server.pycliyml "az postgres server")
...
#### [Конфигурации](postgres\server\configuration.pycliyml "az postgres server configuration")
...
#### [Правила брандмауэра](postgres\server\firewall-rule.pycliyml "az postgres server firewall-rule")
...
## [Кэш Redis](redis.pycliyml "az redis")
...
### [Расписания установки исправлений](redis\patch-schedule.pycliyml "az redis patch-schedule")
...
## [Группы ресурсов](group.pycliyml "az group")
...
### [Развернутые службы](group\deployment.pycliyml "az group deployment")
...
#### [Операции](group\deployment\operation.pycliyml "az group deployment operation")
...
## [Политики ресурсов](policy.pycliyml "az policy")
### [Назначения](policy\assignment.pycliyml "az policy assignment")
...
### [Определения](policy\definition.pycliyml "az policy definition")
...
## [Функции поставщика ресурсов](feature.pycliyml "az feature")
...
## [Поставщики ресурсов](provider.pycliyml "az provider")
...
### [Операция](provider\operation.pycliyml "az provider operation")
...
## [Теги ресурсов](tag.pycliyml "az tag")
...
## [Ресурсы](resource.pycliyml "az resource")
...
### [Ссылки](resource\link.pycliyml "az resource link")
...
## [Роли](role.pycliyml "az role")
### [Назначения](role\assignment.pycliyml "az role assignment")
...
### [Определения](role\definition.pycliyml "az role definition")
...
### [Приложение](sf\application.pycliyml "az sf application")
...
### [Кластер](sf\cluster.pycliyml "az sf cluster")
...
### [Секция](sf\partition.pycliyml "az sf partition")
...
### [Реплика](sf\replica.pycliyml "az sf replica")
...
### [Служба](sf\service.pycliyml "az sf service")
...
### [Хранилища данных](sql\dw.pycliyml "az sql dw")
...
### [Базы данных](sql\db.pycliyml "az sql db")
...
#### [Политика аудита](sql\db\audit-policy.pycliyml "az sql db audit-policy")
...
#### [Реплика](sql\db\replica.pycliyml "az sql db replica")
...
#### [Политика обнаружения угроз](sql\db\threat-policy.pycliyml "az sql db threat-policy")
...
### [Эластичные пулы](sql\elastic-pool.pycliyml "az sql elastic-pool")
...
### [Сервер](sql\server.pycliyml "az sql server")
...
#### [Правила брандмауэра](sql\server\firewall-rule.pycliyml "az sql server firewall-rule")
...
## [Служба хранилища](storage.pycliyml "az storage")
### [Учетные записи](storage\account.pycliyml "az storage account")
...
#### [Ключи](storage\account\keys.pycliyml "az storage account keys")
...
### [Большой двоичный объект](storage\blob.pycliyml "az storage blob")
...
#### [Операции копирования](storage\blob\copy.pycliyml "az storage blob copy")
...
#### [Добавочное копирование](storage\blob\incremental-copy.pycliyml "az storage blob incremental-copy")
...
#### [Аренда](storage\blob\lease.pycliyml "az storage blob lease")
...
#### [Метаданные](storage\blob\metadata.pycliyml "az storage blob metadata")
...
#### [Свойства службы](storage\blob\service-properties.pycliyml "az storage blob service-properties")
##### [Show](storage\blob\service-properties.pycliyml#show "az storage blob service-properties show")
### [Контейнеры](storage\container.pycliyml "az storage container")
...
#### [Аренда](storage\container\lease.pycliyml "az storage container lease")
...
#### [Метаданные](storage\container\metadata.pycliyml "az storage container metadata")
...
#### [Политики](storage\container\policy.pycliyml "az storage container policy")
...
### [Общий доступ к ресурсам независимо от источника](storage\cors.pycliyml "az storage cors")
...
### [Каталоги](storage\directory.pycliyml "az storage directory")
...
#### [Метаданные](storage\directory\metadata.pycliyml "az storage directory metadata")
...
### [Файловые ресурсы](storage\share.pycliyml "az storage share")
...
#### [Метаданные](storage\share\metadata.pycliyml "az storage share metadata")
...
#### [Политики](storage\share\policy.pycliyml "az storage share policy")
...
### [Файлы](storage\file.pycliyml "az storage file")
...
#### [Операции копирования](storage\file\copy.pycliyml "az storage file copy")
...
#### [Метаданные](storage\file\metadata.pycliyml "az storage file metadata")
...
### [Ведение журнала](storage\logging.pycliyml "az storage logging")
...
### [Сообщения](storage\message.pycliyml "az storage message")
...
### [Метрики](storage\metrics.pycliyml "az storage metrics")
...
### [Очереди](storage\queue.pycliyml "az storage queue")
...
#### [Метаданные](storage\queue\metadata.pycliyml "az storage queue metadata")
...
#### [Политики](storage\queue\policy.pycliyml "az storage queue policy")
...
### [Сущности хранилища таблиц](storage\entity.pycliyml "az storage entity")
...
### [Таблицы](storage\table.pycliyml "az storage table")
...
#### [Политики](storage\table\policy.pycliyml "az storage table policy")
...
## [Подписки](account.pycliyml "az account")
...
## [Виртуальные машины](vm.pycliyml "az vm")
...
### [Группы доступности](vm\availability-set.pycliyml "az vm availability-set")
...
### [Диагностика загрузки](vm\boot-diagnostics.pycliyml "az vm boot-diagnostics")
...
### [Система диагностики](vm\diagnostics.pycliyml "az vm diagnostics")
...
### [Шифрование](vm\encryption.pycliyml "az vm encryption")
...
### [Расширения](vm\extension.pycliyml "az vm extension")
...
#### [Образы расширений](vm\extension\image.pycliyml "az vm extension image")
...
### [Образы](vm\image.pycliyml "az vm image")
...
### [Диски хранилища](vm\disk.pycliyml "az vm disk")
#### [Attach](vm\disk.pycliyml#attach "az vm disk attach")
#### [Detach](vm\disk.pycliyml#detach "az vm disk detach")
### [Неуправляемые диски](vm\unmanaged-disk.pycliyml "az vm unmanaged-disk")
...
### [Пользователи](vm\user.pycliyml "az vm user")
...
## [Образы виртуальных машин](image.pycliyml "az image")
...
## [Масштабируемые наборы ВМ](vmss.pycliyml "az vmss")
...
### [Система диагностики](vmss\diagnostics.pycliyml "az vmss diagnostics")
...
#### [Образы](vmss\extension\image.pycliyml "az vmss extension image")
...
## [Веб-приложения](webapp.pycliyml "az webapp")
...
### [Конфигурация](webapp\config.pycliyml "az webapp config")
#### [Set](webapp\config.pycliyml#set "az webapp config set")
#### [Show](webapp\config.pycliyml#show "az webapp config show")
#### [Параметры приложения](webapp\config\appsettings.pycliyml "az webapp config appsettings")
...
#### [Резервная копия](webapp\config\backup.pycliyml "az webapp config backup")
...
#### [Контейнер](webapp\config\container.pycliyml "az webapp config container")
...
#### [Имя узла](webapp\config\hostname.pycliyml "az webapp config hostname")
...
### [Развертывание](webapp\deployment.pycliyml "az webapp deployment")
...
#### [Слот](webapp\deployment\slot.pycliyml "az webapp deployment slot")
...
#### [Источник](webapp\deployment\source.pycliyml "az webapp deployment source")
...
#### [Пользователь](webapp\deployment\user.pycliyml "az webapp deployment user")
...
### [Журнал](webapp\log.pycliyml "az webapp log")
