...
|Виртуальные машины | Обучающий модуль | [Управление виртуальными машинами с помощью Azure CLI](https://docs.microsoft.com/learn/modules/manage-virtual-machines-with-azure-cli/) | Создайте, запустите, остановите виртуальную машину и попробуйте другие задачи управления для нее.
...
| | | | |
|-|-|-|-|
|Виртуальная сеть|Краткое руководство | [Создание виртуальной сети с помощью Azure CLI](/azure/virtual-network/quick-create-cli) | Создайте виртуальную сеть, разверните в ней две виртуальные машины и подключитесь к ним из Интернета.
...
| | | | |
|-|-|-|-|
|Конфигурация приложений Azure|Примеры |[Примеры Azure CLI для службы "Конфигурация приложений Azure"](/azure/azure-app-configuration/cli-samples) | Получите ссылки на скрипты Bash, которые используют Azure CLI, для службы "Конфигурация приложений Azure".
...
|MySQL|Краткое руководство |[Создание базы данных Azure для сервера MySQL с помощью Azure CLI](/azure/mysql/quickstart-create-mysql-server-database-using-azure-cli) | Создайте базу данных Azure для сервера MySQL.  Настройте правило брандмауэра и параметры SSL.  Получите и примените сведения о подключении.
...
HDInsight |Руководство |[Создание кластеров HDInsight с помощью Azure CLI](/azure/hdinsight/hdinsight-hadoop-create-linux-clusters-azure-cli) | Создайте кластер HDInsight 3.6.
...
Key Vault |Практическое руководство |[Управление Key Vault с помощью Azure CLI](/azure/key-vault/key-vault-manage-with-cli2) | Создайте хранилище Azure Key Vault и управляйте им.  Зарегистрируйте приложение и разрешения для него, настройте расширенные политики доступа и изучите команды кроссплатформенного интерфейса командной строки.
...
Cognitive Services |Руководство |[Создание ресурса Cognitive Services с помощью интерфейса командной строки Azure](/azure/cognitive-services/cognitive-services-apis-create-account-cli) | Зарегистрируйтесь в Azure Cognitive Services и создайте учетную запись с подпиской на одну или несколько служб.  Используйте созданные для вас ключи и конечную точку для аутентификации приложений.
...
## <a name="geographies"></a>Географические регионы
