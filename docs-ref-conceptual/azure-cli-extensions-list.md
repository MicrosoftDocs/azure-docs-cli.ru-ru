...
| [sap-hana](https://github.com/Azure/azure-hanaonazure-cli-extension) | 0.5.3 | Дополнительные команды для работы с экземплярами SAP HanaOnAzure. |  |
