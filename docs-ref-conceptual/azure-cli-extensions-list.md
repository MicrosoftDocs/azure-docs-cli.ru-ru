...
| [dms-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/dms-preview) | 0.5.0 | Поддержка новых сценариев Database Migration Service. | Yes |
...
| [mesh](https://github.com/Azure/azure-cli-extensions) | 0.9.3 | Поддержка Сетки Microsoft Azure Service Fabric (общедоступная предварительная версия) | Yes |
...
| [storage-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/storage-preview) | 0.1.7 | Предварительная версия ожидаемых функций хранилища. | Yes |
...
| [webapp](https://github.com/Azure/azure-cli-extensions) | 0.2.14 | Дополнительные команды для Службы приложений Azure. | Yes |
